...
public class ColorVal {
    ...
    public final static LinearGradient SPECTATING_CT_BACKGROUND = new LinearGradient(0, 0, 1, 0, true, CycleMethod.NO_CYCLE,
            new Stop(0, Color.web("#2d3586")), new Stop(1, Color.web("#3f96cc")));
    public final static LinearGradient SPECTATING_T_BACKGROUND = new LinearGradient(0, 0, 1, 0, true, CycleMethod.NO_CYCLE,
